...
object ReceiptFixtures {
    ...
    fun aLiable(userId: String = DEFAULT_USER_ID, rate: BigDecimal = BigDecimal("1.0")): Liable = Liable.builder()
        .userId(userId)
        .rate(rate)
        .build()
    ...
    fun aRateDiscount(category: DiscountType = DiscountType.PROMO, rate: BigDecimal = BigDecimal("0.1")): Discount =
        Discount.builder()
            .category(category)
            .rate(rate)
            .build()

    fun aFlatFee(name: String = "Service Fee", value: MonetaryAmount = aMonetaryAmount()): Fee = Fee.builder()
        .name(name)
        .value(value)
        .build()

    fun aPercentageFee(name: String = "Service Fee", rate: BigDecimal = BigDecimal("0.05")): Fee = Fee.builder()
        .name(name)
        .rate(rate)
        .build()
    ...
    fun aCreateReceiptInput(
        ...
        paymentMethod: PaymentMethod = PaymentMethod.CREDIT,
        subtotal: MonetaryAmount = aMonetaryAmount(),
    ): CreateReceiptInput = CreateReceiptInput.builder()
        .vendorName(vendorName)
        .items(items)
        .occurredAt(occurredAt)
        .paymentMethod(paymentMethod)
    ...
    fun aGetReceiptInput(id: String = DEFAULT_RECEIPT_ID): GetReceiptInput = GetReceiptInput.builder()
        .id(id)
        .build()

    fun aDeleteReceiptInput(id: String = DEFAULT_RECEIPT_ID): DeleteReceiptInput = DeleteReceiptInput.builder()
        .id(id)
        .build()
    ...
    ): UpdateReceiptInput = UpdateReceiptInput.builder()
        .id(id)
