...
object ClerkClaimsFixtures {
    ...
    fun aJwt(claims: Map<String, Any> = EMPTY_CLAIMS): Jwt = Jwt(
    ...
    fun claimsWithRole(role: String = ClerkAuthoritiesConverter.DEFAULT_ROLE): Map<String, Any> = mapOf(
        ClerkAuthoritiesConverter.METADATA_CLAIM to mapOf(
            ClerkAuthoritiesConverter.ROLE_CLAIM to role,
        ),
    )

    fun claimsWithNonStringRole(role: Any = 123): Map<String, Any> = mapOf(
        ClerkAuthoritiesConverter.METADATA_CLAIM to mapOf(
            ClerkAuthoritiesConverter.ROLE_CLAIM to role,
        ),
    )
    ...
    fun claimsWithoutRoleKey(): Map<String, Any> = mapOf(
        ClerkAuthoritiesConverter.METADATA_CLAIM to mapOf(
